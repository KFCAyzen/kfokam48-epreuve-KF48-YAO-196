// Seul point d'appel réseau du front (F3) : tous les modules de src/api passent par ici.
...
export async function requete<T>(chemin: string, options: Options = {}): Promise<T> {
  ...
  try {
    ...
    throw new ApiError(0, 'RESEAU', "Impossible de joindre le serveur. Vérifie ta connexion.")
  }
